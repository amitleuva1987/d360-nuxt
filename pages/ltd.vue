  ...
  <div class="bg-white">
    <main>
          ...
          >
            <div>
              <div class="mt-20">
                <div>
                  <a
                    href="https://rudybekker.com/tag/discover360/"
                  ...
                  >
                    ...
                    >
                    <span
                      class="inline-flex items-center space-x-1 text-sm font-medium text-indigo-600"
                    >
                ...
                <form
                  @submit.prevent="processHomeActions"
                  class="mt-12 sm:flex sm:w-full sm:max-w-lg"
                >
      ...
      <div class="relative overflow-hidden pt-16 pb-32">
        <div
          aria-hidden="true"
          class="absolute inset-x-0 top-0 h-48 bg-white"
        />
        <div class="relative">
          <div
